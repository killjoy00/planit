...
interface Option { id: string; label: string; dateValue: string | null; voteCount: number }
...
interface Winner { id: string; label: string; dateValue: string | null }
        ...
        <div className="rounded-xl bg-indigo-50 border border-indigo-200 p-6 text-center">
          ...
          {h.winner.dateValue && (
            <p className="text-gray-500 mt-1">
              {new Date(h.winner.dateValue).toLocaleDateString("en-US", { weekday: "long", month: "long", day: "numeric", year: "numeric" })}
            </p>
          )}
